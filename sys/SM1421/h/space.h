...
#define TIMEZONE (0 * 60) /* Minutes westward from Greenwich */
#define DSTFLAG  0             /* Daylight Saving Time applies here */
#define MAXUSERS 3

#define NBUF    16             /* size of buffer cache, must be <=256*/
...
#define NPROC   29            /* max number of processes */
#define NTEXT   13            /* max number of pure texts */
#define NINODE  62           /* number of in-core inodes */
#define NFILE   77            /* number of file structures */
#define NCALL   6            /* max simultaneous time callouts */
#define NDISK   3                  /* number of disks to monitor */

#define NFLOCK  22                /* Кол-во слотов таблицы flock */

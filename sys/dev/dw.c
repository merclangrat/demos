...
struct dwsize {
	...
	65536,  0,          /* A=cil 0-111 (part1 10Mb disk) */
	65536,  65536,         /* B=cil 112-307 (part2 10Mb disk) */
	131072, 0,         /* C=cil 112-653 (part2 20Mb disk) */
	-1,     65536,           /* D=cil 112-end (part2 unknownMb disk) */
	65536,  0,         /* E=cil 0-153 (full 5Mb disk) */
	65536,  0,          /* F=cil 0-307 (full 10Mb disk) */
	65536,  0,            /* G=cil 0-654 (full 20 Mb disk) */
	-1,     0,              /* H=cil 0-end */
};
